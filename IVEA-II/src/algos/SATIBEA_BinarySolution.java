...
public class SATIBEA_BinarySolution extends BinarySolutionType {
    ...
    int n = 0;
    private ArrayList<List<Integer>> seeds;
    private List<Integer> seed;
    private static Random r = new Random();
    private static final int SATtimeout = 1000;
    private static final long iteratorTimeout = 150000;

    public SATIBEA_BinarySolution(Problem problem, int nFeat, String fm, List<Integer> mandatoryFeaturesIndices, List<Integer> deadFeaturesIndices,ArrayList<List<Integer>> seeds) throws ClassNotFoundException {
        super(problem);
        this.fm = fm;
        this.nFeat = nFeat;
...
//                    }
    ...
    // Called by jmetal.core.Solution
