 ...
 *
 * @author chris
 * edit: xlian by adding more common seeds
 */
public class IVEAII_Problem extends Problem {
    ...
    public static ArrayList<List<Integer>> seeds;
    
    private static final int N_VARS = 1, N_OBJS = 5;

    public IVEAII_Problem(String fm, String augment, String mandatory, String dead, String seedfile) throws Exception {
        ...
        loadSeed(seedfile);
        this.solutionType_ = new SATIBEA_BinarySolution(this, numFeatures, fm,mandatoryFeaturesIndices, deadFeaturesIndices, seeds);
    ...
    public void evaluateConstraints(Solution solution) throws JMException{
         ...
         Binary bin = (Binary) vars[0];
		 // int totalViolations = violations;
    	solution.setNumberOfViolatedConstraint((int)solution.getObjective(0));
    	//solution.setNumberOfViolatedConstraint(numViolatedConstraints(bin));
	}
    ...
    public void loadSeed(String seedfile) throws Exception{
    	...
    	seeds = new ArrayList<List<Integer>>();
        List<Integer> seed;
