...
//    for(int i = 1; i < solution1.numberOfVariables(); i++)
//    {
...
//    }
    ...
    //in the framework of SATIBEA, objective(0) stores the violations
    if (solution1.getObjective(0) < 
        solution2.getObjective(0)) {
      return -1;
    } else if (solution2.getObjective(0) < 
               solution1.getObjective(0)) {
      return 1;
    }
