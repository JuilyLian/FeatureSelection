 ...
 */
public class Algo_Settings extends Settings {
     ...
     * Constructor
     */
    public Algo_Settings(Problem p) {
        super(p.getName());
    ...
    public Algorithm configureASE2013(long maxRunTimeMS) throws JMException {
        ...
        crossover = new IBEA_SinglePointCrossover(parameters);
     ...
     * 
     * */
    public Algorithm configureIVEAII(long maxRunTimeMS, String fm, int numFeat, List<List<Integer>> constr) throws JMException {
    	populationSize_ = 300;
        ...
        algorithm = new IVEAII(problem_,maxRunTimeMS);
        ...
        parameters = new HashMap();
        parameters.put("probability", mutationProbability_);
        mutation = new IVEAII_ReplaceMutation(parameters,numFeat);
